...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_line_checkers_utils_bonus.c                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tchobert <tchobert@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/18 18:35:50 by tchobert          #+#    #+#             */
/*   Updated: 2024/10/03 19:52:47 by tchobert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	is_correct_size(const char *line, t_game_data *game_data)
{
	...
	return (line_size == game_data->map_data.map_columns_number);
}

bool	is_surrounded_by_walls(const char *line, t_game_data *game_data)
{
	return ((line[0] == WALL)
		&& (line[game_data->map_data.map_columns_number - 1] == WALL));
}
